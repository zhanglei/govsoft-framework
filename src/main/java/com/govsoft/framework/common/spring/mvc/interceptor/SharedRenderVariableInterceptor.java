package com.govsoft.framework.common.spring.mvc.interceptor;
...
import com.govsoft.framework.web.httpinclude.HttpInclude;
import com.govsoft.framework.web.scope.Flash;
...
public class SharedRenderVariableInterceptor extends HandlerInterceptorAdapter
	...
	private void initSharedRenderVariables() {
		...
		globalRenderVariables.put("url_prefix",
				"http://www.govsoft-framework.com");
		globalRenderVariables.put("img_url_prefix",
				"http://img.govsoft-framework.com");
		globalRenderVariables.put("media_url_prefix",
				"http://media.govsoft-framework.com");
		globalRenderVariables.put("static_url_prefix",
				"http://static.govsoft-framework.com");
